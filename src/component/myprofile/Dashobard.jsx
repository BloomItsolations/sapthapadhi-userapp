  ...
  return (
    <div className='flex  items-center flex-col gap-5   '>
      <div className='w-[95%] lg:w-[740px] h-auto lg:h-[420px] bg-[#EDEDED] flex justify-center items-center mt-2'>
       ...
       {
        userData?.userDetails?.profilePhoto ?  <img src={`https://sapthapadhi.bloomitsolutions.co.in/${userData?.userDetails?.profilePhoto[0]?.path}`} className='w-[100%] lg:w-[700px] h-auto lg:h-[380px] rounded-[15px] ' /> :        <img src={`https://www.pngitem.com/pimgs/m/35-350426_profile-icon-png-default-profile-picture-png-transparent.png`} className='w-[100%] lg:w-[700px] h-auto lg:h-[380px] rounded-[15px] ' />
